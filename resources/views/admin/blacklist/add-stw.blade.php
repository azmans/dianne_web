...
@section('content')
    <div class="container" style="margin-top: 10%">
        <div class="row justify-content-center">
            ...
            <hr>
                <form method="POST" id="blacklist_stw">
                 @csrf
                    ...
                    <div class="row">
                        <div class="col-sm">
                            <a href="/admin/view/soon-to-wed/{{ $user->id }}" role="button" class="btn button_1">Back</a>
                        </div>
                        <div class="col-sm">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" id="submit" class="btn btn-success" href="/admin/soon-to-wed/{{ $user->id }}/blacklist">Blacklist User</button>
                </div>
            </div>
        </div>
    </div>
